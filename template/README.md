This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app) and [Quickstart Redux Template](https://github.com/morewings/cra-template-quickstart-redux).
